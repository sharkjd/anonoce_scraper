...
def build_graph():
    ...
    graph.add_node("blue_collar_classification_node", blue_collar_classification_node)
    ...
    graph.add_edge("validate_and_normalize_node", "blue_collar_classification_node")
    graph.add_edge("blue_collar_classification_node", "export_csv_node")
